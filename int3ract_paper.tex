...
ranges for each variable are extracted from the \texttt{lm}/\texttt{glm}
object but need to be supplied explicitly to \texttt{freq\_int(0)}.
...
formation when altX changes moderately, around -1 to 1 (see green to
blue curves). While reciprocity gets more positive with increasing
